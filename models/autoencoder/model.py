...
class AudioToImageAutoencoder(nn.Module):
    def __init__(self, audio_dim=191, latent_dim=1024):
        ...
        # Audio feature processing with layer normalization
        ...
        self.encoder_mu = nn.Linear(2048, latent_dim)
        self.encoder_logvar = nn.Linear(2048, latent_dim)
        
        # Initial projection with adaptive layer norm
        self.projection = nn.Sequential(
            nn.Linear(latent_dim, 16 * 16 * 256),
            nn.LayerNorm(16 * 16 * 256),
            nn.ReLU(),
            nn.Dropout(0.1)
        )
        ...
        # Color refinement with deep supervision
    ...
    def decode(self, z):
        ...
        # Project to spatial features with checkpointing
        if self.use_checkpointing:
            x = torch.utils.checkpoint.checkpoint(
                self.projection,
                z,
        ...
        # Apply decoder blocks with checkpointing
        ...
        # Apply style processing with checkpointing
